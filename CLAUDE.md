...
This project is indexed by GitNexus as **mini-web-server** (1652 symbols, 2829 relationships, 139 execution flows). Use GitNexus graph tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/mini-web-server/context` | Codebase overview, check index freshness |
| `gitnexus://repo/mini-web-server/clusters` | All functional areas |
| `gitnexus://repo/mini-web-server/processes` | All execution flows |
| `gitnexus://repo/mini-web-server/process/{name}` | Step-by-step execution trace |
