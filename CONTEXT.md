...
- `wwwroot/index.html` is the default static page for `/`.
...
- **Web root**: The directory files can be served from. The current web root is `wwwroot`.
...
7. Map the parsed path to a file under `wwwroot`.
