...
> Status: complete. All six slices (4.1-4.6) are built, experimented, and noted. The race fix that this milestone deliberately left for Milestone 5 lives at `docs/learning/m5-race-lab.md`.

**This is the original slice plan**, kept for reference. Each slice's actual learning note (with what was built, observed, and learned) lives in `docs/learning/s4.*.md`. For current runtime behavior and the role of this milestone in the project, see `CONTEXT.md`.
...
Write in a new file `docs/learning/s4.1-single-thread-blocking.md`.
...
Write in a new file `docs/learning/s4.2-thread-per-connection.md`.
...
Write in a new file `docs/learning/s4.3-scheduling-non-determinism.md`.
...
Write in a new file `docs/learning/s4.4-shared-address-space.md`.
...
Write in a new file `docs/learning/s4.5-race-condition-prep.md`.
...
Write in a new file `docs/learning/s4.6-thread-per-connection-limits.md`.
